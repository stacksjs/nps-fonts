...
// Vertical metrics (shared across families to keep pairing trivial).
...
export const FAMILY_DISPLAY: Record<FamilyId, FamilyMeta> = {
  ...
  'redwood-serif': {
    ...
    file: 'RedwoodSerif',
    tagline: 'Old-style serif with bracketed serifs and stroke contrast — naturalist field-journal warmth.',
    hero: 'Redwood',
  ...
  'sequoia-sans': {
    display: 'Sequoia Sans',
    file: 'SequoiaSans',
    tagline: 'High-contrast humanist sans for park field guides — variable weight Thin → Wide.',
    hero: 'Sequoia',
    pangram: 'YOSEMITE valley · est 1864 · Half Dome · Tioga Pass',
    weight: 400,
    style: 'normal',
  },
  'switchback': {
    display: 'Switchback',
    file: 'Switchback',
    tagline: 'Routed-trail display caps with Clean and Rough sibling cuts — backcountry signage.',
    hero: 'SWITCHBACK',
    pangram: 'NORTH RIM · 7100 FT · NEXT WATER 4 MI',
    weight: 400,
    style: 'normal',
  },
}
