 ...
 * Uses ts-font-editor to instantiate a static TTF at each axis position
...
for (const [i, w] of WEIGHTS.entries()) {
  ...
  const ab = instBuf.buffer.slice(instBuf.byteOffset, instBuf.byteOffset + instBuf.byteLength)
